...
public class FishCommandPipeImpl extends ASTWrapperPsiElement implements FishCommandPipe {

  public FishCommandPipeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FishVisitor visitor) {
    visitor.visitCommandPipe(this);
  }
