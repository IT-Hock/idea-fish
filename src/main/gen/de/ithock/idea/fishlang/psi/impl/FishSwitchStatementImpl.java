...
public class FishSwitchStatementImpl extends ASTWrapperPsiElement implements FishSwitchStatement {

  public FishSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FishEndOfLine getEndOfLine() {
    return findNotNullChildByClass(FishEndOfLine.class);
  }

  @Override
  @NotNull
  public List<FishCaseStatement> getCaseStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FishCaseStatement.class);
  }
