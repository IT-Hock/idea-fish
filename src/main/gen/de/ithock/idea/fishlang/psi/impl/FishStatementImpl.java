...
public class FishStatementImpl extends ASTWrapperPsiElement implements FishStatement {

  public FishStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FishIfStatement getIfStatement() {
    return findNotNullChildByClass(FishIfStatement.class);
  }
