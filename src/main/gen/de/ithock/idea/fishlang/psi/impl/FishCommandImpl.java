...
public class FishCommandImpl extends ASTWrapperPsiElement implements FishCommand {

  public FishCommandImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FishCommandIdentifier getCommandIdentifier() {
    return findNotNullChildByClass(FishCommandIdentifier.class);
  }
