...
public class FishIfStatementImpl extends ASTWrapperPsiElement implements FishIfStatement {

  public FishIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FishExpression getExpression() {
    return findNotNullChildByClass(FishExpression.class);
  }
