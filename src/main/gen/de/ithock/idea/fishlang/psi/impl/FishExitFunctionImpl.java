...
public class FishExitFunctionImpl extends ASTWrapperPsiElement implements FishExitFunction {

  public FishExitFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FishVisitor visitor) {
    visitor.visitExitFunction(this);
  }
