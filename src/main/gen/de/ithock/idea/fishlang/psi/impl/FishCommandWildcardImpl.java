...
public class FishCommandWildcardImpl extends ASTWrapperPsiElement implements FishCommandWildcard {

  public FishCommandWildcardImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FishVisitor visitor) {
    visitor.visitCommandWildcard(this);
  }
